...
/**
 * @fileoverview  Implement the mouse drag wrapper class, GSDragger, that
...
goog.provide('ginsu.events.Dragger');

goog.require('goog.fx.Dragger');

/**
 * Constructor for the GSDragger object.  This is a subclass of goog.fx.Dragger
 ...
 */
ginsu.events.Dragger = function(opt_element) {
  goog.fx.Dragger.call(this, opt_element || document);
};
goog.inherits(ginsu.events.Dragger, goog.fx.Dragger);
 ...
 * @override
 */
ginsu.events.Dragger.prototype.defaultAction = function(x, y) {
